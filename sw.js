const CACHE='section-admin-password-v12-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-admin-password-v12.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
