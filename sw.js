const CACHE='section-users-v8-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-users-v8.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
