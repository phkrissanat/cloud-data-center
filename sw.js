const CACHE='section-password-v9-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-password-v9.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
