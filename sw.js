const CACHE='section-filter-v14-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-filter-v14.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
