const CACHE='section-design-final-v1-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-filter-v14.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./header-logo-b.png'].map(p=>new URL(p,self.registration.scope).href);
