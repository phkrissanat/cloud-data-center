const CACHE='section-history-v10-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-history-v10.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
