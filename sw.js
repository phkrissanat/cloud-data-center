const CACHE='section-complete-v11-'+self.registration.scope;
const ASSETS=['./','./index.html','./style.css','./app-complete-v11.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'].map(p=>new URL(p,self.registration.scope).href);
